 ...
 */
export const getCompletedProjects = (employeeId: number) => {
  return fetchData(`/api/client-evaluations/projects?employee_id=${employeeId}`);
};
...
export const getEvaluationItems = () => {
  return fetchData('/api/client-evaluations/items');
};
